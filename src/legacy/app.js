...
(function(){
  ...
  // Union/statutory holiday data, keyed by REGION. The no-shoot days genuinely differ by
  // jurisdiction, so one list per agreement -- not one per country.
  //
  // ⛔ GENERATED by tools/gen_holidays.py from RULES. Do not edit a date by hand: change the
  // rule and regenerate. tools/validate_holidays.py diffs the output against this block.
  // Sources verified 2026-09-11. Years 2026-2030.
  //
  // Selection principle (see PROJECT-CONTEXT section 5):
  //   1. anchor on the CREW agreement -- crew off means no shoot day, whatever DGA/SAG say
  //   2. within crew, break ties toward MORE -- over-reserving is recoverable, a blown wrap is not
  //   3. never double-count an either/or (Quebec's Good Friday OR Easter Monday is one day)
  //   4. every holiday is individually switchable off, which is what makes 2 safe
  //
  // Weekend handling: a holiday landing on Sat/Sun also emits an '(Observed)' weekday entry.
  // US shifts Sat->Fri / Sun->Mon per ASA Art. 7. Canada/UK/Victoria roll forward to the next
  // free weekday. Lithuania does not transfer at all.
  const HOLIDAYS = {
    // United States — IATSE general -- IATSE Area Standards Agreement (Art. 7) · West Coast Studio Local Agreements (¶ 9(e)(4))
    // source: https://www.asa.iatse.net/  (verified 2026-09-11)
    'US-GEN': [
      ...
      {date:'2030-06-19', name:'Juneteenth'},
      {date:'2030-07-04', name:'Independence Day'},
      {date:'2030-09-02', name:'Labor Day'},
      {date:'2030-11-28', name:'Thanksgiving'},
      {date:'2030-11-29', name:'Day After Thanksgiving'},
      {date:'2030-12-25', name:'Christmas Day'},
    ],
    // New York — IATSE Local 52 -- Local 52 Feature & Television Production Contract with Major Producers, Part A § 11
    // source: https://amptp.org/contracts/  (verified 2026-09-11)
    'US-NY': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      {date:'2026-01-19', name:'Martin Luther King Jr. Day'},
      {date:'2026-02-16', name:'Presidents\' Day'},
    ...
    // British Columbia -- BCCFU Master Agreement, Article Seven (§§ 7.01–7.05) → BC Employment Standards Act
    // source: https://cmpa.ca/wp-content/uploads/2025/08/2025-BCCFU-Master-Agreement.pdf  (verified 2026-09-11)
    'CA-BC': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      ...
      {date:'2030-08-05', name:'B.C. Day'},
      {date:'2030-09-02', name:'Labour Day'},
      {date:'2030-09-30', name:'National Day for Truth and Reconciliation'},
      {date:'2030-10-14', name:'Thanksgiving'},
      {date:'2030-11-11', name:'Remembrance Day'},
      {date:'2030-12-25', name:'Christmas Day'},
    ],
    // Ontario -- DGC/CMPA Standard Agreement, Ontario Schedule Art. ON4.02 · IATSE Local 873
    // source: https://cmpa.ca/wp-content/uploads/2026/05/DGC-CMPA-Standard-Agreement-2026-2028-ONTARIO-Final-website.pdf  (verified 2026-09-11)
    'CA-ON': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      {date:'2026-02-16', name:'Family Day'},
      {date:'2026-04-03', name:'Good Friday'},
    ...
    // Quebec -- AQTIS 514 AIEST–AQPM Productions américaines Art. 11 → Télévision Art. 13.1 → CNESST
    // source: https://www.aqpm.ca/relations-de-travail/television/aqtis-514-aiest/  (verified 2026-09-11)
    'CA-QC': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      {date:'2026-04-03', name:'Good Friday'},
      ...
      {date:'2030-01-01', name:'New Year\'s Day'},
      {date:'2030-04-19', name:'Good Friday'},
      {date:'2030-05-20', name:'National Patriots’ Day'},
      {date:'2030-06-24', name:'Fête nationale (St-Jean-Baptiste)'},
      {date:'2030-07-01', name:'Canada Day'},
      {date:'2030-09-02', name:'Labour Day'},
      {date:'2030-10-14', name:'Thanksgiving'},
      {date:'2030-12-25', name:'Christmas Day'},
    ],
    // Alberta -- Provincial employment standards
    // source: https://www.alberta.ca/general-holidays-pay  (verified 2026-09-11)
    'CA-AB': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      ...
      {date:'2029-12-25', name:'Christmas Day'},
      {date:'2030-01-01', name:'New Year\'s Day'},
      {date:'2030-02-18', name:'Alberta Family Day'},
      {date:'2030-04-19', name:'Good Friday'},
      {date:'2030-05-20', name:'Victoria Day'},
      {date:'2030-07-01', name:'Canada Day'},
      {date:'2030-09-02', name:'Labour Day'},
    ...
    // Manitoba -- Provincial employment standards
    // source: https://www.gov.mb.ca/labour/standards/  (verified 2026-09-11)
    'CA-MB': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      ...
      {date:'2029-12-25', name:'Christmas Day'},
      {date:'2030-01-01', name:'New Year\'s Day'},
      {date:'2030-02-18', name:'Louis Riel Day'},
      {date:'2030-04-19', name:'Good Friday'},
      {date:'2030-05-20', name:'Victoria Day'},
      {date:'2030-07-01', name:'Canada Day'},
      {date:'2030-09-02', name:'Labour Day'},
    ...
    // Nova Scotia -- Provincial employment standards
    // source: https://novascotia.ca/lae/employmentrights/holidaychart.asp  (verified 2026-09-11)
    'CA-NS': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      ...
      {date:'2029-12-25', name:'Christmas Day'},
      {date:'2030-01-01', name:'New Year\'s Day'},
      {date:'2030-02-18', name:'Nova Scotia Heritage Day'},
      {date:'2030-04-19', name:'Good Friday'},
      {date:'2030-07-01', name:'Canada Day'},
      {date:'2030-09-02', name:'Labour Day'},
      {date:'2030-12-25', name:'Christmas Day'},
    ],
    // England & Wales -- Pact/Bectu Scripted TV Agreement cl. 11 · Major Motion Picture Agreement cl. 5.6
    // source: https://www.gov.uk/bank-holidays  (verified 2026-09-11)
    'UK-EW': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      {date:'2026-04-03', name:'Good Friday'},
    ...
    // Scotland -- Pact/Bectu Scripted TV Agreement cl. 11 · Major Motion Picture Agreement cl. 5.6
    // source: https://www.gov.uk/bank-holidays  (verified 2026-09-11)
    'UK-SCT': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      ...
      {date:'2026-05-04', name:'Early May Bank Holiday'},
      {date:'2026-05-25', name:'Spring Bank Holiday'},
      {date:'2026-06-15', name:'World Cup Bank Holiday'},   // ONE-OFF -- government-declared, no rule produces this
      ...
      {date:'2026-12-28', name:'Boxing Day (Observed)'},
      {date:'2027-01-01', name:'New Year\'s Day'},
      {date:'2027-01-02', name:'2nd January'},
      {date:'2027-01-04', name:'2nd January (Observed)'},
      {date:'2027-03-26', name:'Good Friday'},
      {date:'2027-05-03', name:'Early May Bank Holiday'},
      {date:'2027-05-31', name:'Spring Bank Holiday'},
      ...
      {date:'2027-12-28', name:'Boxing Day (Observed)'},
      {date:'2028-01-01', name:'New Year\'s Day'},
      {date:'2028-01-02', name:'2nd January'},
      {date:'2028-01-03', name:'New Year\'s Day (Observed)'},
      {date:'2028-01-04', name:'2nd January (Observed)'},
      {date:'2028-04-14', name:'Good Friday'},
      {date:'2028-05-01', name:'Early May Bank Holiday'},
      {date:'2028-05-29', name:'Spring Bank Holiday'},
      ...
      {date:'2029-12-26', name:'Boxing Day'},
      {date:'2030-01-01', name:'New Year\'s Day'},
      {date:'2030-01-02', name:'2nd January'},
      {date:'2030-04-19', name:'Good Friday'},
      {date:'2030-05-06', name:'Early May Bank Holiday'},
      {date:'2030-05-27', name:'Spring Bank Holiday'},
      {date:'2030-08-05', name:'Summer Bank Holiday'},
      {date:'2030-11-30', name:'St Andrew\'s Day'},
      {date:'2030-12-02', name:'St Andrew\'s Day (Observed)'},
      {date:'2030-12-25', name:'Christmas Day'},
      {date:'2030-12-26', name:'Boxing Day'},
    ],
    // Northern Ireland -- Pact/Bectu Scripted TV Agreement cl. 11 · Major Motion Picture Agreement cl. 5.6
    // source: https://www.gov.uk/bank-holidays  (verified 2026-09-11)
    'UK-NI': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      ...
      {date:'2026-05-04', name:'Early May Bank Holiday'},
      {date:'2026-05-25', name:'Spring Bank Holiday'},
      {date:'2026-07-12', name:'Battle of the Boyne'},
      {date:'2026-07-13', name:'Battle of the Boyne (Observed)'},
      {date:'2026-08-31', name:'Summer Bank Holiday'},
      {date:'2026-12-25', name:'Christmas Day'},
      {date:'2026-12-26', name:'Boxing Day'},
      {date:'2026-12-28', name:'Boxing Day (Observed)'},
      ...
      {date:'2027-05-03', name:'Early May Bank Holiday'},
      {date:'2027-05-31', name:'Spring Bank Holiday'},
      {date:'2027-07-12', name:'Battle of the Boyne'},
      {date:'2027-08-30', name:'Summer Bank Holiday'},
      {date:'2027-12-25', name:'Christmas Day'},
      {date:'2027-12-26', name:'Boxing Day'},
      {date:'2027-12-27', name:'Christmas Day (Observed)'},
      ...
      {date:'2028-05-01', name:'Early May Bank Holiday'},
      {date:'2028-05-29', name:'Spring Bank Holiday'},
      {date:'2028-07-12', name:'Battle of the Boyne'},
      {date:'2028-08-28', name:'Summer Bank Holiday'},
      {date:'2028-12-25', name:'Christmas Day'},
      {date:'2028-12-26', name:'Boxing Day'},
      {date:'2029-01-01', name:'New Year\'s Day'},
      {date:'2029-03-17', name:'St Patrick\'s Day'},
      {date:'2029-03-19', name:'St Patrick\'s Day (Observed)'},
      {date:'2029-03-30', name:'Good Friday'},
      {date:'2029-04-02', name:'Easter Monday'},
      {date:'2029-05-07', name:'Early May Bank Holiday'},
      {date:'2029-05-28', name:'Spring Bank Holiday'},
      {date:'2029-07-12', name:'Battle of the Boyne'},
      {date:'2029-08-27', name:'Summer Bank Holiday'},
      {date:'2029-12-25', name:'Christmas Day'},
      {date:'2029-12-26', name:'Boxing Day'},
      {date:'2030-01-01', name:'New Year\'s Day'},
      {date:'2030-03-17', name:'St Patrick\'s Day'},
      {date:'2030-03-18', name:'St Patrick\'s Day (Observed)'},
      {date:'2030-04-19', name:'Good Friday'},
      {date:'2030-04-22', name:'Easter Monday'},
      {date:'2030-05-06', name:'Early May Bank Holiday'},
      {date:'2030-05-27', name:'Spring Bank Holiday'},
      {date:'2030-07-12', name:'Battle of the Boyne'},
      {date:'2030-08-26', name:'Summer Bank Holiday'},
      {date:'2030-12-25', name:'Christmas Day'},
      {date:'2030-12-26', name:'Boxing Day'},
    ],
    // Berlin -- Statutory — Gesetz über die Sonn- und Feiertage (Berlin). Crew: TV FFS (ver.di / Produzentenallianz), holiday clause UNVERIFIED
    // source: https://www.berlin.de/sen/inneres/buerger-und-staat/verfassungs-und-verwaltungsrecht/artikel.1435639.php  (verified 2026-09-11)
    'DE-BE': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      {date:'2026-03-08', name:'International Women\'s Day (Internationaler Frauentag)'},
      ...
      {date:'2026-12-26', name:'Boxing Day (2. Weihnachtstag)'},
      {date:'2027-01-01', name:'New Year\'s Day'},
      {date:'2027-03-08', name:'International Women\'s Day (Internationaler Frauentag)'},
      ...
      {date:'2027-12-26', name:'Boxing Day (2. Weihnachtstag)'},
      {date:'2028-01-01', name:'New Year\'s Day'},
      {date:'2028-03-08', name:'International Women\'s Day (Internationaler Frauentag)'},
      ...
      {date:'2028-05-25', name:'Ascension Day (Christi Himmelfahrt)'},
      {date:'2028-06-05', name:'Whit Monday (Pfingstmontag)'},
      {date:'2028-10-03', name:'German Unity Day (Tag der Deutschen Einheit)'},
      {date:'2028-12-25', name:'Christmas Day (1. Weihnachtstag)'},
      {date:'2028-12-26', name:'Boxing Day (2. Weihnachtstag)'},
      {date:'2029-01-01', name:'New Year\'s Day'},
      {date:'2029-03-08', name:'International Women\'s Day (Internationaler Frauentag)'},
      {date:'2029-03-30', name:'Good Friday (Karfreitag)'},
      {date:'2029-04-02', name:'Easter Monday (Ostermontag)'},
      {date:'2029-05-01', name:'Labour Day (Tag der Arbeit)'},
      {date:'2029-05-10', name:'Ascension Day (Christi Himmelfahrt)'},
      {date:'2029-05-21', name:'Whit Monday (Pfingstmontag)'},
      {date:'2029-10-03', name:'German Unity Day (Tag der Deutschen Einheit)'},
      {date:'2029-12-25', name:'Christmas Day (1. Weihnachtstag)'},
      {date:'2029-12-26', name:'Boxing Day (2. Weihnachtstag)'},
      {date:'2030-01-01', name:'New Year\'s Day'},
      {date:'2030-03-08', name:'International Women\'s Day (Internationaler Frauentag)'},
      {date:'2030-04-19', name:'Good Friday (Karfreitag)'},
      {date:'2030-04-22', name:'Easter Monday (Ostermontag)'},
      {date:'2030-05-01', name:'Labour Day (Tag der Arbeit)'},
      {date:'2030-05-30', name:'Ascension Day (Christi Himmelfahrt)'},
      {date:'2030-06-10', name:'Whit Monday (Pfingstmontag)'},
      {date:'2030-10-03', name:'German Unity Day (Tag der Deutschen Einheit)'},
      {date:'2030-12-25', name:'Christmas Day (1. Weihnachtstag)'},
      {date:'2030-12-26', name:'Boxing Day (2. Weihnachtstag)'},
    ],
    // Brandenburg -- Statutory — Feiertagsgesetz (FTG) Brandenburg 2003. Crew: TV FFS (ver.di / Produzentenallianz), holiday clause UNVERIFIED
    // source: https://bravors.brandenburg.de/gesetze/ftg_2003/6  (verified 2026-09-11)
    'DE-BB': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      {date:'2026-04-03', name:'Good Friday (Karfreitag)'},
      {date:'2026-04-05', name:'Easter Sunday (Ostersonntag)'},
      {date:'2026-04-06', name:'Easter Monday (Ostermontag)'},
      {date:'2026-05-01', name:'Labour Day (Tag der Arbeit)'},
      {date:'2026-05-14', name:'Ascension Day (Christi Himmelfahrt)'},
      {date:'2026-05-24', name:'Whit Sunday (Pfingstsonntag)'},
      {date:'2026-05-25', name:'Whit Monday (Pfingstmontag)'},
      {date:'2026-10-03', name:'German Unity Day (Tag der Deutschen Einheit)'},
      {date:'2026-10-31', name:'Reformation Day (Reformationstag)'},
      {date:'2026-12-25', name:'Christmas Day (1. Weihnachtstag)'},
      {date:'2026-12-26', name:'Boxing Day (2. Weihnachtstag)'},
      {date:'2027-01-01', name:'New Year\'s Day'},
      {date:'2027-03-26', name:'Good Friday (Karfreitag)'},
      {date:'2027-03-28', name:'Easter Sunday (Ostersonntag)'},
      {date:'2027-03-29', name:'Easter Monday (Ostermontag)'},
      {date:'2027-05-01', name:'Labour Day (Tag der Arbeit)'},
      {date:'2027-05-06', name:'Ascension Day (Christi Himmelfahrt)'},
      {date:'2027-05-16', name:'Whit Sunday (Pfingstsonntag)'},
      {date:'2027-05-17', name:'Whit Monday (Pfingstmontag)'},
      {date:'2027-10-03', name:'German Unity Day (Tag der Deutschen Einheit)'},
      {date:'2027-10-31', name:'Reformation Day (Reformationstag)'},
      {date:'2027-12-25', name:'Christmas Day (1. Weihnachtstag)'},
      {date:'2027-12-26', name:'Boxing Day (2. Weihnachtstag)'},
      {date:'2028-01-01', name:'New Year\'s Day'},
      {date:'2028-04-14', name:'Good Friday (Karfreitag)'},
      {date:'2028-04-16', name:'Easter Sunday (Ostersonntag)'},
      {date:'2028-04-17', name:'Easter Monday (Ostermontag)'},
      {date:'2028-05-01', name:'Labour Day (Tag der Arbeit)'},
      {date:'2028-05-25', name:'Ascension Day (Christi Himmelfahrt)'},
      {date:'2028-06-04', name:'Whit Sunday (Pfingstsonntag)'},
      {date:'2028-06-05', name:'Whit Monday (Pfingstmontag)'},
      {date:'2028-10-03', name:'German Unity Day (Tag der Deutschen Einheit)'},
      {date:'2028-10-31', name:'Reformation Day (Reformationstag)'},
      {date:'2028-12-25', name:'Christmas Day (1. Weihnachtstag)'},
      {date:'2028-12-26', name:'Boxing Day (2. Weihnachtstag)'},
      {date:'2029-01-01', name:'New Year\'s Day'},
      {date:'2029-03-30', name:'Good Friday (Karfreitag)'},
      {date:'2029-04-01', name:'Easter Sunday (Ostersonntag)'},
      {date:'2029-04-02', name:'Easter Monday (Ostermontag)'},
      {date:'2029-05-01', name:'Labour Day (Tag der Arbeit)'},
      {date:'2029-05-10', name:'Ascension Day (Christi Himmelfahrt)'},
      {date:'2029-05-20', name:'Whit Sunday (Pfingstsonntag)'},
      {date:'2029-05-21', name:'Whit Monday (Pfingstmontag)'},
      {date:'2029-10-03', name:'German Unity Day (Tag der Deutschen Einheit)'},
      {date:'2029-10-31', name:'Reformation Day (Reformationstag)'},
      {date:'2029-12-25', name:'Christmas Day (1. Weihnachtstag)'},
      {date:'2029-12-26', name:'Boxing Day (2. Weihnachtstag)'},
      {date:'2030-01-01', name:'New Year\'s Day'},
      {date:'2030-04-19', name:'Good Friday (Karfreitag)'},
      {date:'2030-04-21', name:'Easter Sunday (Ostersonntag)'},
      {date:'2030-04-22', name:'Easter Monday (Ostermontag)'},
      {date:'2030-05-01', name:'Labour Day (Tag der Arbeit)'},
      {date:'2030-05-30', name:'Ascension Day (Christi Himmelfahrt)'},
      {date:'2030-06-09', name:'Whit Sunday (Pfingstsonntag)'},
      {date:'2030-06-10', name:'Whit Monday (Pfingstmontag)'},
      {date:'2030-10-03', name:'German Unity Day (Tag der Deutschen Einheit)'},
      {date:'2030-10-31', name:'Reformation Day (Reformationstag)'},
      {date:'2030-12-25', name:'Christmas Day (1. Weihnachtstag)'},
      {date:'2030-12-26', name:'Boxing Day (2. Weihnachtstag)'},
    ],
    // Victoria (Melbourne) -- MEAA Motion Picture Production Agreement → Broadcasting, Recorded Entertainment and Cinemas Award 2020 [MA000091] → Public Holidays Act 1993 (Vic)
    // source: https://business.vic.gov.au/business-information/public-holidays  (verified 2026-09-11)
    'AU-VIC': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      ...
      {date:'2026-09-25', name:'AFL Grand Final Friday'},   // PROVISIONAL -- confirm against the published fixture each year
      ...
      {date:'2027-09-24', name:'AFL Grand Final Friday'},   // PROVISIONAL -- confirm against the published fixture each year
      ...
      {date:'2028-09-29', name:'AFL Grand Final Friday'},   // PROVISIONAL -- confirm against the published fixture each year
      {date:'2028-11-07', name:'Melbourne Cup Day'},
      {date:'2028-12-25', name:'Christmas Day'},
      {date:'2028-12-26', name:'Boxing Day'},
      {date:'2029-01-01', name:'New Year\'s Day'},
      {date:'2029-01-26', name:'Australia Day'},
      {date:'2029-03-12', name:'Labour Day'},
      {date:'2029-03-30', name:'Good Friday'},
      ...
      {date:'2029-09-28', name:'AFL Grand Final Friday'},   // PROVISIONAL -- confirm against the published fixture each year
      {date:'2029-11-06', name:'Melbourne Cup Day'},
      {date:'2029-12-25', name:'Christmas Day'},
      {date:'2029-12-26', name:'Boxing Day'},
      {date:'2030-01-01', name:'New Year\'s Day'},
      {date:'2030-01-26', name:'Australia Day'},
      {date:'2030-01-28', name:'Australia Day (Observed)'},
      {date:'2030-03-11', name:'Labour Day'},
      {date:'2030-04-19', name:'Good Friday'},
      ...
      {date:'2030-09-27', name:'AFL Grand Final Friday'},   // PROVISIONAL -- confirm against the published fixture each year
      {date:'2030-11-05', name:'Melbourne Cup Day'},
      {date:'2030-12-25', name:'Christmas Day'},
      {date:'2030-12-26', name:'Boxing Day'},
    ],
    // Lithuania -- Lietuvos Respublikos darbo kodeksas (Labour Code) Art. 123 — 'Švenčių dienos'
    // source: https://e-seimas.lrs.lt/portal/legalAct/lt/TAD/10c6bfd07bd511e6a0f68fd135e6f40c  (verified 2026-09-11)
    'LT': [
      {date:'2026-01-01', name:'New Year\'s Day'},
      {date:'2026-02-16', name:'Day of Restoration of the State'},
      {date:'2026-03-11', name:'Day of Restoration of Independence'},
      {date:'2026-04-05', name:'Easter Sunday'},
      {date:'2026-04-06', name:'Easter Monday'},
      {date:'2026-05-01', name:'International Workers\' Day'},
      {date:'2026-05-03', name:'Mother\'s Day'},
      {date:'2026-06-07', name:'Father\'s Day'},
      {date:'2026-06-24', name:'St John\'s Day (Rasos / Joninės)'},
      {date:'2026-07-06', name:'Statehood Day'},
      {date:'2026-08-15', name:'Assumption Day (Žolinė)'},
      {date:'2026-11-01', name:'All Saints\' Day'},
      {date:'2026-11-02', name:'All Souls\' Day'},
      {date:'2026-12-24', name:'Christmas Eve (Kūčios)'},
      {date:'2026-12-25', name:'Christmas Day'},
      {date:'2026-12-26', name:'Second Day of Christmas'},
      {date:'2027-01-01', name:'New Year\'s Day'},
      {date:'2027-02-16', name:'Day of Restoration of the State'},
      {date:'2027-03-11', name:'Day of Restoration of Independence'},
      {date:'2027-03-28', name:'Easter Sunday'},
      {date:'2027-03-29', name:'Easter Monday'},
      {date:'2027-05-01', name:'International Workers\' Day'},
      {date:'2027-05-02', name:'Mother\'s Day'},
      {date:'2027-06-06', name:'Father\'s Day'},
      {date:'2027-06-24', name:'St John\'s Day (Rasos / Joninės)'},
      {date:'2027-07-06', name:'Statehood Day'},
      {date:'2027-08-15', name:'Assumption Day (Žolinė)'},
      {date:'2027-11-01', name:'All Saints\' Day'},
      {date:'2027-11-02', name:'All Souls\' Day'},
      {date:'2027-12-24', name:'Christmas Eve (Kūčios)'},
      {date:'2027-12-25', name:'Christmas Day'},
      {date:'2027-12-26', name:'Second Day of Christmas'},
      {date:'2028-01-01', name:'New Year\'s Day'},
      {date:'2028-02-16', name:'Day of Restoration of the State'},
      {date:'2028-03-11', name:'Day of Restoration of Independence'},
      {date:'2028-04-16', name:'Easter Sunday'},
      {date:'2028-04-17', name:'Easter Monday'},
      {date:'2028-05-01', name:'International Workers\' Day'},
      {date:'2028-05-07', name:'Mother\'s Day'},
      {date:'2028-06-04', name:'Father\'s Day'},
      {date:'2028-06-24', name:'St John\'s Day (Rasos / Joninės)'},
      {date:'2028-07-06', name:'Statehood Day'},
      {date:'2028-08-15', name:'Assumption Day (Žolinė)'},
      {date:'2028-11-01', name:'All Saints\' Day'},
      {date:'2028-11-02', name:'All Souls\' Day'},
      {date:'2028-12-24', name:'Christmas Eve (Kūčios)'},
      {date:'2028-12-25', name:'Christmas Day'},
      {date:'2028-12-26', name:'Second Day of Christmas'},
      {date:'2029-01-01', name:'New Year\'s Day'},
      {date:'2029-02-16', name:'Day of Restoration of the State'},
      {date:'2029-03-11', name:'Day of Restoration of Independence'},
      {date:'2029-04-01', name:'Easter Sunday'},
      {date:'2029-04-02', name:'Easter Monday'},
      {date:'2029-05-01', name:'International Workers\' Day'},
      {date:'2029-05-06', name:'Mother\'s Day'},
      {date:'2029-06-03', name:'Father\'s Day'},
      {date:'2029-06-24', name:'St John\'s Day (Rasos / Joninės)'},
      {date:'2029-07-06', name:'Statehood Day'},
      {date:'2029-08-15', name:'Assumption Day (Žolinė)'},
      {date:'2029-11-01', name:'All Saints\' Day'},
      {date:'2029-11-02', name:'All Souls\' Day'},
      {date:'2029-12-24', name:'Christmas Eve (Kūčios)'},
      {date:'2029-12-25', name:'Christmas Day'},
      {date:'2029-12-26', name:'Second Day of Christmas'},
      {date:'2030-01-01', name:'New Year\'s Day'},
      {date:'2030-02-16', name:'Day of Restoration of the State'},
      {date:'2030-03-11', name:'Day of Restoration of Independence'},
      {date:'2030-04-21', name:'Easter Sunday'},
      {date:'2030-04-22', name:'Easter Monday'},
      {date:'2030-05-01', name:'International Workers\' Day'},
      {date:'2030-05-05', name:'Mother\'s Day'},
      {date:'2030-06-02', name:'Father\'s Day'},
      {date:'2030-06-24', name:'St John\'s Day (Rasos / Joninės)'},
      {date:'2030-07-06', name:'Statehood Day'},
      {date:'2030-08-15', name:'Assumption Day (Žolinė)'},
      {date:'2030-11-01', name:'All Saints\' Day'},
      {date:'2030-11-02', name:'All Souls\' Day'},
      {date:'2030-12-24', name:'Christmas Eve (Kūčios)'},
      {date:'2030-12-25', name:'Christmas Day'},
  ...
  // ✅ RULING 9 (owner, 22 Sep 2026): the SHOOTING ORDER of the episodes, as episode ids. EMPTY MEANS
  // NATURAL ORDER (201, 202, ...), and it stays empty until someone actually drags an episode --
  // so opening a calendar saved before this existed mutates nothing: no phantom undo step, no
  // "unsaved changes" on a file nobody touched. effectiveShootOrder() is the only reader.
  // ⛔ A SEPARATE store, never a reordering of episodeDefs: an episode's default NAME is derived
  // from its POSITION in that array (defaultEpisodeName(i)), so sorting it would renumber the show
  // -- 201 would become whatever was shot first. Here 201 is 201 wherever it is shot.
  // ⛔ LABELS, NOT DATES: the order decides which days each episode occupies, never how many days
  // Production has. Σ days is order-independent, so the wrap cannot move.
  let episodeShootOrder = [];
  ...
  function renderHolidayVisList(schedule){
    ...
    const placeEl = document.getElementById('union-place');
    const hasCountry = placeEl ? !!placeEl.value : false;
    if(!shown.length){
      ...
      laneSegs.forEach(s=>{
        ...
        if(!replacedByEpisodes){
          pillRunsForWeek(schedule, weekStart, s).forEach(r=>{
            ...
            // ⛔ FROZEN EDIT, owner-approved 16 Sep 2026 against BLOCKS-PLAN.md §5 (ruling 3), shaped
            // by the owner on 22 Sep 2026 on seeing the first PDFs: "why can't the block
            // number/episode numbers be written in the green pills as smaller grey text next to
            // production wk". So the block tag is a SPAN INSIDE Production's own pill, not a lane
            // of its own -- which costs NO height at all, where the first cut cost one lane on every
            // shooting week. It names the blocks of THIS run's days (a pill split by a holiday names
            // each piece's own). Ruling 8 (22 Sep) then gave Episodes mode the same shape: the
            // episodes being shot, as grey text in "Production Week N", replacing the episode pills
            // (see episodeSpans()). `blkTag` is '' on every other phase, on a one-day piece (ruling
            // 7), and with both "Show" preferences off (ruling 10) -- and then the title and text are
            // byte-identical to the pre-Blocks pill.
            const blkTag = (s.key === 'production') ? productionPillTag(schedule, weekStart, r.startCol, r.endCol) : '';
            place(r.startCol, r.endCol, 'mv-bar mv-pill',
              `background:${bg}; color:${fg};` + halfSlices(weekStart, r.startCol, r.endCol),
              escHtml(lbl) + (blkTag ? ' · ' + escHtml(blkTag) : ''),
              escHtml(lbl) + (blkTag ? '<span class="mv-pill-block">' + escHtml(blkTag) + '</span>' : ''),
              `data-ph="${s.key}"`);
          });
        }
  ...
  // A block holds a SET (§4.2) -- shoots group out of order -- so each list is kept in SHOOTING
  // order purely for display; within a block the order carries no meaning.
  function reconcileBlockEpisodes(){
    if(!blockDefs.length) return;
    // Shooting order, not episode number (ruling 9): the automatic split fills Block 1 with the
    // FIRST episodes shot, which is what a block is.
    const ids = effectiveShootOrder();
  ...
  // The episode ids in shooting order (ruling 9). A hand order is RECONCILED on read, never
  // rewritten: an id no longer in the episode list drops out, and an episode the order does not
  // know (the count went up after the reorder) is shot LAST, in episode order.
  function effectiveShootOrder(){
    const ids = episodeDefs.map(e=> e.id);
    if(!episodeShootOrder.length) return ids;
    const known = new Set(ids), seen = new Set(), out = [];
    episodeShootOrder.forEach(id=>{ if(known.has(id) && !seen.has(id)){ seen.add(id); out.push(id); } });
    ids.forEach(id=>{ if(!seen.has(id)) out.push(id); });
    return out;
  }

  // Listed in SHOOTING order (ruling 9), each row with a grip that drags it to a new position.
  // Names and numbers never change with the order -- the list is episodeDefs, re-sequenced for
  // display by effectiveShootOrder().
  ...
  // ✅ RULING 8 (owner, 22 Sep 2026): there are NO EPISODE PILLS any more, in either mode. During
  // production the pill's primary text is always "Production Week N", and the episodes being shot
  // are the GREY SUBTEXT inside it (productionPillTag below) -- the look the block tag established.
  // Returning [] is what hands Production's lane back to Production's own pills: the frozen
  // renderer draws them whenever this is empty, so no frozen line changes for it. The renderer's
  // episode-pill branch is now unreachable, and deliberately left alone rather than edited out.
  // ⛔ THIS DELIBERATELY CHANGES THE MONTH PDF OF EVERY EPISODIC CALENDAR (its pills said
  // "Episode 201"); the monthprint baselines were re-cut for it, with the PDFs shown to the owner.
  // (Ruling 5, the Blocks-mode half of the same decision, came first.)
  function episodeSpans(schedule){
    return [];
  }

  // Which episode each Production shoot day belongs to, in SHOOTING order (ruling 9): episodes
  // consume the shoot days in the order they are shot, each taking its day count of ENTRIES --
  // the rule episodeSpans() always had, including the owner's 18 Sep ruling that it counts
  // entries, not work (a half day is one entry). iso -> episode def. Cached per schedule object.
  const _episodeDayCache = new WeakMap();
  function episodeDayMap(schedule){
    let m = _episodeDayCache.get(schedule);
    if(m) return m;
    m = new Map();
    const prod = (schedule.segments || []).find(s=> s.key === 'production');
    if(prod && prod.shootDays && prod.shootDays.length && showInfoStatus().complete){
      const byId = new Map(episodeDefs.map(e=>[e.id, e]));
      let cursor = 0;
      effectiveShootOrder().forEach(id=>{
        const e = byId.get(id);
        const n = parseInt(e && e.days, 10);
        if(!e || !Number.isFinite(n) || n <= 0) return;
        prod.shootDays.slice(cursor, cursor + n).forEach(iso=> m.set(iso, e));
        cursor += n;
      });
    }
    _episodeDayCache.set(schedule, m);
    return m;
  }

  // The GREY TEXT inside one run of Production's pill -- columns fromCol..toCol of one Sun-Sat row
  // -- or ''. Frozen renderMonthView appends it to Production's pill, and adds nothing when it is ''.
  //   Blocks mode    the blocks the run touches (ruling 2: every one), each with its episodes
  //                  (ruling 5): "Block 1 · Ep. 201, 202"  /  "Block 1 · Ep. 201, 202 / Block 2 · Ep. 203–205"
  //   Episodes mode  the episodes whose shoot days fall in the run, in shooting order (ruling 8):
  //                  "Ep. 201"  /  "Ep. 201, 202"
  //   "Ep." (owner, 22 Sep 2026: "Can we put 'Ep' before the episode numbers", then "Maybe it should
  //   be 'Ep.'") is written ONCE per list, not per number -- the three-block worst case had 43 px to spare before it, and a prefix
  //   on every number would have spent it.
  //   Preferences    "Show Blocks" / "Show Episodes" drop their half (ruling 10); both off is ''.
  // Blocks consume the shoot days exactly as episodes do (above): in order, by entries, so halves
  // that push a calendar past Σ blocks leave the trailing entries untagged rather than inventing a
  // block for them.
  const _blockDayCache = new WeakMap();
  function productionPillTag(schedule, weekStart, fromCol, toCol){
    // ✅ RULING 7 (owner, 22 Sep 2026): a ONE-DAY piece of the pill carries no grey text. There is
    // no room -- "Production Week 16" alone nearly fills a single day column, and the tag truncated
    // to "Bl…" -- and the neighbouring week already names it. Offered instead: shrinking the text
    // to fit; the owner chose omission.
    if(toCol <= fromCol) return '';
    const showB = mvShowBlocks(), showE = mvShowEpisodes();
    if(!isBlocksMode()){
      if(!showE) return '';
      const m = episodeDayMap(schedule), seen = [];
      for(let i=fromCol;i<=toCol;i++){
        const e = m.get(isoOf(addDays(weekStart, i)));
        if(e && !seen.includes(e)) seen.push(e);
      }
      const eps = episodeListLabel(seen);
      return eps ? 'Ep. ' + eps : '';
    }
    if(!blockDefs.length || (!showB && !showE)) return '';
    let dayBlock = _blockDayCache.get(schedule);
    if(!dayBlock){
      dayBlock = new Map();
      const prod = (schedule.segments || []).find(s=> s.key === 'production');
      if(prod && prod.shootDays){
        let cursor = 0;
        blockDefs.forEach((b, bi)=>{
          const n = parseInt(b.days, 10);
          if(!Number.isFinite(n) || n <= 0) return;
          prod.shootDays.slice(cursor, cursor + n).forEach(iso=> dayBlock.set(iso, bi));
          cursor += n;
        });
      }
      _blockDayCache.set(schedule, dayBlock);
    }
    const touched = [];
    for(let i=fromCol;i<=toCol;i++){
      const bi = dayBlock.get(isoOf(addDays(weekStart, i)));
      if(bi !== undefined && !touched.includes(bi)) touched.push(bi);
    }
    const byId = new Map(episodeDefs.map(e=>[e.id, e]));
    return touched.map(bi=>{
      const b = blockDefs[bi];
      const eps = showE ? episodeListLabel((b.episodes || []).map(id=> byId.get(id)).filter(Boolean)) : '';
      return [showB ? (b.name || ('Block ' + (bi + 1))) : '', eps ? 'Ep. ' + eps : ''].filter(Boolean).join(' · ');
    }).filter(Boolean).join(' / ');
  }

  // Episodes for the grey text: short names, with runs of THREE or more consecutive episode numbers
  // folded to a range ("201–203") -- it is the run that eats width in a narrow day column. Two stay
  // listed ("201, 202"), because a range of two reads as a typo. A name that is not a plain number
  // ("Pilot") is never folded. Order is the caller's (shooting order).
  function episodeListLabel(defs){
    const names = defs.map(shortEpisodeName);
    const out = [];
    for(let i=0;i<names.length;){
      let j = i;
      while(j + 1 < names.length && /^\d+$/.test(names[j]) && /^\d+$/.test(names[j+1])
            && parseInt(names[j+1], 10) === parseInt(names[j], 10) + 1) j++;
      if(j - i >= 2){ out.push(names[i] + '–' + names[j]); }
      else { for(let k=i;k<=j;k++) out.push(names[k]); }
      i = j + 1;
    }
    return out.join(', ');
  }
  ...
  // freeze it (a frozen holiday note would wrongly survive a union-place change).
  ...
  // ✅ RULING 10 (owner, 22 Sep 2026): the month view's grey pill text -- blocks, episodes -- can be
  // switched off per user. ABSENT MEANS ON: the store holds only `false`, so a fresh user sees
  // everything and a later migration never has to guess what a stored `true` meant.
  // ⛔ NOT calendar data -- per-user, like gridlines -- so NEVER in captureSnapshot(), and the change
  // re-renders WITHOUT update(): update() ends in markDirty(), and flipping a preference must not
  // mark someone's calendar unsaved or push an undo step.
  function mvShowBlocks(){ return prefs.mvBlocks !== false; }
  function mvShowEpisodes(){ return prefs.mvEpisodes !== false; }
  function reflectMonthTagPrefs(){
    const b = document.getElementById('pref-mv-blocks'); if(b) b.checked = mvShowBlocks();
    const e = document.getElementById('pref-mv-episodes'); if(e) e.checked = mvShowEpisodes();
  }
  document.addEventListener('change', e=>{
    const id = e.target && e.target.id;
    if(id !== 'pref-mv-blocks' && id !== 'pref-mv-episodes') return;
    const key = id === 'pref-mv-blocks' ? 'mvBlocks' : 'mvEpisodes';
    if(e.target.checked) delete prefs[key]; else prefs[key] = false;
    savePrefs();
  ...
  // WHERE the production shoots, which is what a user knows -- resolved to WHICH AGREEMENT
  // governs, which is what the holiday math needs. Several places share one agreement: nine US
  // markets are the same Area Standards list, so the collapse is structural rather than luck.
  //
  // `caveat` is the thing a region key could never express. Chicago and San Francisco are
  // expressly carved out of the Area Standards Agreement by name and neither local publishes its
  // agreement, so their list is a PROXY, not a finding -- and the user has to be told.
  const PLACES = {
    'us-atlanta': {region:'US-GEN', label:'Atlanta, GA',
      locals:'IATSE Local 479 — Georgia excl. Savannah, Alabama excl. Mobile',
      caveat:null},
    'us-chicago': {region:'US-GEN', label:'Chicago, IL',
      locals:'IATSE Local 476 · Teamsters 727',
      caveat:'Area Standards proxy. The ASA preamble excludes Illinois and Local 476 by name, and Local 476 does not publish its agreement. Confirm before locking dates.'},
    'us-florida': {region:'US-GEN', label:'Florida — statewide',
      locals:'IATSE Local 477 — the whole state',
      caveat:null},
    'us-los-angeles': {region:'US-GEN', label:'Los Angeles, CA',
      locals:'Craft by craft — Locals 44, 80, 600, 695, 700, 705, 706, 728, 729, 800, 871, 884, 892 · Teamsters 399',
      caveat:null},
    'us-maryland': {region:'US-GEN', label:'Maryland / DC',
      locals:'IATSE Local 487 — Mid-Atlantic, incl. DC and Virginia',
      caveat:null},
    'us-miami': {region:'US-GEN', label:'Miami, FL',
      locals:'IATSE Local 477 — same as all Florida · Teamsters 769',
      caveat:null},
    'us-new-mexico': {region:'US-GEN', label:'New Mexico',
      locals:'IATSE Local 480',
      caveat:null},
    'us-new-orleans': {region:'US-GEN', label:'New Orleans, LA',
      locals:'IATSE Local 478 — Louisiana, S. Mississippi, Mobile AL',
      caveat:'Mardi Gras is not in ASA Article 7, and the agreement has no mechanism for adding a regional holiday. If your show observes it, add it as a custom holiday.'},
    'us-new-york': {region:'US-NY', label:'New York, NY',
      locals:'IATSE Local 52, plus 161, 764, 798, USA 829 on separate paper · Teamsters 817',
      caveat:null},
    'us-oahu': {region:'US-GEN', label:'Oahu, HI',
      locals:'IATSE Local 665 — State of Hawaii',
      caveat:'Prince Kūhiō Day, King Kamehameha Day and Statehood Day are not in ASA Article 7. Add as custom holidays if the production observes them.'},
    'us-pittsburgh': {region:'US-GEN', label:'Pittsburgh, PA',
      locals:'IATSE Local 489',
      caveat:null},
    'us-puerto-rico': {region:'US-GEN', label:'Puerto Rico',
      locals:'IATSE Local 494 — PR and USVI',
      caveat:'Puerto Rico\'s statutory calendar differs materially from the federal one and none of those days are in ASA Article 7 — the widest statute-to-agreement gap of any US market here.'},
    'us-san-francisco': {region:'US-GEN', label:'San Francisco, CA',
      locals:'IATSE Local 16 — Stage Employees',
      caveat:'Area Standards proxy. The ASA excludes Local 16\'s jurisdiction by name, so Northern California sits outside both national agreements. Confirm before locking dates.'},
    'us-general': {region:'US-GEN', label:'Elsewhere in the U.S. — Area Standards',
      locals:'The Area Standards local holding that jurisdiction',
      caveat:null},
    'ca-montreal': {region:'CA-QC', label:'Montreal, QC',
      locals:'AQTIS 514 IATSE · UDA (French) / ACTRA (English)',
      caveat:null},
    'ca-toronto': {region:'CA-ON', label:'Toronto, ON',
      locals:'IATSE Local 873 · DGC Ontario · NABET 700-M',
      caveat:null},
    'ca-vancouver': {region:'CA-BC', label:'Vancouver, BC',
      locals:'IATSE 891, Teamsters 155, ICG 669 (BCCFU) · UBCP/ACTRA',
      caveat:null},
    'ca-alberta': {region:'CA-AB', label:'Alberta — province-wide',
      locals:'Provincial employment standards',
      caveat:null},
    'ca-bc': {region:'CA-BC', label:'British Columbia — province-wide',
      locals:'BCCFU Master Agreement',
      caveat:null},
    'ca-manitoba': {region:'CA-MB', label:'Manitoba — province-wide',
      locals:'Provincial employment standards',
      caveat:null},
    'ca-nova-scotia': {region:'CA-NS', label:'Nova Scotia — province-wide',
      locals:'Provincial employment standards',
      caveat:null},
    'ca-ontario': {region:'CA-ON', label:'Ontario — province-wide',
      locals:'IATSE Local 873 · DGC Ontario',
      caveat:null},
    'ca-quebec': {region:'CA-QC', label:'Quebec — province-wide',
      locals:'AQTIS 514 IATSE',
      caveat:null},
    'uk-london': {region:'UK-EW', label:'London',
      locals:'Bectu / Pact · Equity',
      caveat:null},
    'uk-scotland': {region:'UK-SCT', label:'Scotland',
      locals:'Bectu / Pact — same agreements as London, different bank holidays',
      caveat:null},
    'uk-belfast': {region:'UK-NI', label:'Belfast',
      locals:'Bectu / Pact — same agreements as London, two more bank holidays',
      caveat:null},
    'uk-wales': {region:'UK-EW', label:'Wales',
      locals:'Bectu / Pact — same agreements AND same bank holidays as England',
      caveat:null},
    'de-berlin': {region:'DE-BE', label:'Berlin',
      locals:'ver.di / Produzentenallianz (TV FFS)',
      caveat:'Shooting at Studio Babelsberg? That is Potsdam, which is BRANDENBURG — pick Brandenburg instead. It has Reformation Day and no Women\u2019s Day, so the two lists differ in both directions.'},
    'de-brandenburg': {region:'DE-BB', label:'Brandenburg — incl. Studio Babelsberg',
      locals:'ver.di / Produzentenallianz (TV FFS)',
      caveat:'Statutory list, verified against the Brandenburg Feiertagsgesetz. The TV FFS crew agreement\u2019s own holiday clause was NOT verified — confirm before locking dates.'},
    'au-melbourne': {region:'AU-VIC', label:'Melbourne, VIC',
      locals:'MEAA · Screen Producers Australia',
      caveat:null},
    'eu-lithuania': {region:'LT', label:'Lithuania',
      locals:'No crew collective agreement identified — Labour Code Art. 123 governs',
      caveat:null},
  };
  const DEFAULT_PLACE = 'us-general';

  // The HOLIDAYS key for the current selection, or null for "None". A place is never itself a
  // HOLIDAYS key -- it always resolves through PLACES.
  function effectiveRegionKey(){
    const v = (document.getElementById('union-place') || {}).value || '';
    if(!v) return null;
    const p = PLACES[v];
    return (p && HOLIDAYS[p.region]) ? p.region : null;
  }
  // ⚠️ VERIFIED 14 Sep 2026: the DEFAULT_PLACE line below NEVER FIRES, and the comment that
  // used to sit here claimed the opposite -- that an unknown value "falls back to the default
  // rather than silently resolving to None". A <select> coerces an unmatched value to '' at
  // ASSIGNMENT, so by the time this runs el.value is already '' and the `el.value &&` guard is
  // false. An unrecognised place therefore lands on None, not us-general.
  // Left as-is deliberately, on both counts: forward compatibility is out of scope (CLAUDE.md --
  // "old file into new app", never the reverse), and None is the safer landing anyway. Silently
  // applying a US holiday list to a place this build cannot identify would be worse than applying
  // none. The line stays as belt-and-braces for any future caller that sets the value somewhere
  // the DOM does not coerce it.
  function normalizeRegionSelection(){
    const el = document.getElementById('union-place');
    if(!el) return;
    if(el.value && !PLACES[el.value]) el.value = DEFAULT_PLACE;
    reflectRegionUI();
  }
  // One select now, so there are no dependent rows to show or hide. What this reflects instead is
  // the RESOLUTION -- which agreement the chosen place lands on, its locals, and any caveat --
  // because that is the part a city name hides.
  function reflectRegionUI(){
    const el = document.getElementById('union-place');
    if(!el) return;
    const p = PLACES[el.value];
    const res = document.getElementById('union-resolves');
    const loc = document.getElementById('union-locals');
    const cav = document.getElementById('union-caveat');
  ...
  // ⚠️ IT HIDES IN MONTH VIEW AGAIN, on the owner's instruction (22 Sep 2026): "Single column mode
  // setting should only show in waterfall view". It stopped hiding on 10 Sep, when it moved to the
  // Preferences card, on the argument that a row vanishing by view was the more confusing choice;
  // the owner has ruled the other way. The hiding is pure CSS (.pref-view-sheet, legacy.css) off the
  // view toggle's .active -- this function, and the value it reflects, are untouched by it.
  ...
  (function(){
    ...
    host.addEventListener('dragstart', (e)=>{
      ...
      if(!grip) return;
      const row = grip.closest('.episode-row');
      dragRow = row.dataset.id;
      e.dataTransfer.effectAllowed = 'move';
      try { e.dataTransfer.setData('text/plain', row.querySelector('.ep-name').value); } catch(_){}
  ...
  // Re-sequence one episode in the shooting order. ⛔ LABELS, NOT DATES: the order changes which
  // days each episode occupies, never Production's length -- Σ days does not depend on order.
  // One move is ONE undo step (the flush/commit pair moveEpisodeToBlock uses, for the same reason).
  function moveEpisodeInShootOrder(id, targetId, side){
    if(!id || !targetId || id === targetId) return false;
    const order = effectiveShootOrder().filter(x=> x !== id);
    const at = order.indexOf(targetId);
    if(at < 0) return false;
    order.splice(side === 'before' ? at : at + 1, 0, id);
    if(order.join('|') === effectiveShootOrder().join('|')) return false;
    pushUndoSnapshot();
    episodeShootOrder = order;
    // In Blocks mode the automatic split follows the shooting order; a hand arrangement is kept.
    reconcileBlockEpisodes();
    renderEpisodeRows();
    update();
    pushUndoSnapshot();
  ...
  function resetAll(){
    ...
    refreshSimPostUI();
    // ⚠️ One select now. This block used to clear #union-country and park the two dependent
    // selects on their defaults; all three ids are gone, and so are DEFAULT_PROVINCE /
    // DEFAULT_US_AREA / lastCountry / lastSubregion / lastUsArea. Left as it was, the first line
    // threw on null and Reset All died HALF DONE -- phases and sim-post cleared, the show title,
    // episodes, notes and hiatuses below untouched.
    // '' is 'None', which is exactly what the old country='' meant: effectiveRegionKey() returned
    // null then and returns null now, so the reset lands on the same holiday-free state.
    const placeEl = document.getElementById('union-place');
  ...
  function captureSnapshot(){
    return {
      ...
      // Ruling 9, 22 Sep 2026: the episodes' SHOOTING order, as ids. [] = natural order.
      episodeShootOrder,
  ...
  // ⛔ SAVE-FORMAT MIGRATION -- must run BEFORE the fields.byId replay, not after.
  // The replay does `const node = document.getElementById(id); if(!node) return;`, so once
  // #union-usregion and #union-subregion no longer exist, a file saved by v1.2.0 would have its
  // region silently DROPPED and a New York calendar would reopen on the General list. Folding the
  // three legacy keys into one #union-place key here is what stops that.
  //
  // Province-level saves migrate to the province-wide entry, not to that province's city, so a
  // restore is faithful to what the user actually chose. Same list either way; only the label.
  const LEGACY_PROVINCE_PLACE = {
  ...
  function migrateRegionSnapshot(snap){
    ...
    let place = '';
    if(!country){
      // Empty country meant "None". The other two selects still carried their resting values, so
      // promoting those would switch holidays ON for a calendar that deliberately had none.
      place = '';
    } else if(country === 'US'){
      place = (usArea === 'US-NY') ? 'us-new-york' : 'us-general';
    } else if(country === 'CA' || country === 'CAN'){     // 'CAN' = the pre-split saved value
      place = LEGACY_PROVINCE_PLACE[prov] || 'ca-bc';
    } else if(country === 'UK' || country === 'UK-EW'){
      place = 'uk-london';
    } else if(country === 'UK-SCT'){ place = 'uk-scotland';
    } else if(country === 'AU-VIC'){ place = 'au-melbourne';
    } else if(country === 'LT'){     place = 'eu-lithuania'; }
    byId['union-place'] = {value: place};
  ...
  function applyStateSnapshot(snap){
    ...
    lastDroppedBlocks = [];
    // Unconditional, [] = natural order: a file without the key must not inherit the previously
    // open calendar's shooting order.
    episodeShootOrder = Array.isArray(snap.episodeShootOrder)
      ? snap.episodeShootOrder.filter(x=> typeof x === 'string') : [];
