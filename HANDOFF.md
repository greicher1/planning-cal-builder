...
E1 finished. Four local commits on top of `be40696`, **none pushed.** The open-items table below
(rows marked 2 Sep) is the record. **Previously updated 31 Aug 2026, on top of `6e3754d`.** ⚠️ **Read the master list in §2b-3 (rows 27–49)
