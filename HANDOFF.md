...
⏭ Still to come: more tenants (`GRID_TEXT_COLOR`, `WF_PDF_MODE`), and **header presets** —
...
version number typed in Show Info that lands in the bottom-left header slot by default. Planned in full
